...
public class BigNumberTest {
    ...
    public void sumes() {
        ...
        b1 = new BigNumber("50");
        b2 = new BigNumber("50");
        assertEquals(new BigNumber("100"), b1.add(b2));

        b1 = new BigNumber("50000");
        b2 = new BigNumber("50000");
        assertEquals(new BigNumber("100000"), b1.add(b2));
    ...
    public void multiplicacions() {
        ...
        b1 = new BigNumber("2");
        b2 = new BigNumber("2");
        assertEquals(b1, b2);assertEquals(new BigNumber("4"), b1.mult(b2));
        ...
        b2 = new BigNumber("3");
        assertEquals(new BigNumber("462"), b1.mult(b2));
    ...
    public void divisions() {
        ...
        b1 = new BigNumber("125");
        b2 = new BigNumber("5");
        assertEquals(new BigNumber("25"), b1.div(b2));
    ...
    public void potencies() {
        ...
        b1 = new BigNumber("5");assertEquals(new BigNumber("25"), b1.power(2));
